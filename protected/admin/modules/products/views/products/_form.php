...
<div class="form">
        ...
        <div class="form-group">
                ...
                <div class="form-group">
                        ...
                        <div class="col-sm-10">
                                <?php echo CHtml::activeDropDownList($model, 'brand_id', CHtml::listData(MasterBrands::model()->findAll(), 'id', 'brand_name'), array('empty' => '--Select--', 'class' => 'form-control')); ?>
