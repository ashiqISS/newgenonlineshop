...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('display_from')); ?>:</b>
	<?php echo CHtml::encode($data->display_from); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('display_to')); ?>:</b>
	<?php echo CHtml::encode($data->display_to); ?>
	<br />
