...
<div class="form">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <?php echo $form->textField($model, 'merchant_id', ($readOnly == 'true') ? array('class' => 'form-control', "readonly" => "true", 'value' => $model->merchant->fullname) : array('class' => 'form-control') ); ?>
    ...
    if($readOnly == "true")
    {
       ...
       <div class="form-group">
        <div class="col-sm-2 control-label"> 
           ...
           <div class="col-sm-10" style="padding: .5em;padding-left: 1em;">
         <?php
         echo   MerchantDetails::getShopname($model->merchant_id);
         ?>
        </div>
    </div>
    <?php 
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <?php echo $form->textField($model, 'available_balance', ($readOnly == 'true') ? array('class' => 'form-control', "readonly" => "true") : array('class' => 'form-control') ); ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <?php echo $form->textField($model, 'requested_amount', ($readOnly == 'true') ? array('class' => 'form-control', "readonly" => "true") : array('class' => 'form-control') ); ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <?php
            if ($readOnly == "true") {
                $acc_details = BankingDetails::model()->findByPk($model->payment_account);
                if (!empty($acc_details)) {
                    ?>
            <div style="padding: .5em;">
                    <?php
                    if ($acc_details->account_type == 1) {
                        echo "Paypal : " . $acc_details->paypal_id . ', ' . $acc_details->email;
                    } else {
                        echo "Bank Acc : " . $acc_details->account_number . ', ' . $acc_details->bank_name;
                    }
                    ?>
            </div>
                    <?php
