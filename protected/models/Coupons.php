...
class Coupons extends CActiveRecord {
        ...
        public function rules() {
                ...
                return array(
                    array('code,discount,status', 'required'),
                    ...
                    array('id, user_id, cash_limit, gift_card_amount, code, gift_card_id, starting_date, expiry_date, discount, discount_type, unique, type, status, DOC, DOU, session_id, product_id', 'safe', 'on' => 'search'),
                );
        }
