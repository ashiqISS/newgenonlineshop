...
//                
//                  $billing->attributes = $_POST['bill_address'];
//                  print_r($_POST['bill_address']);
//               
//            } else {
//
...
//            }
                ...
                if (($bill_address_id != '') && ($ship_address_id != '')) {
                    ...
                    $this->createOrder($total_amt, $ship_address_id, $bill_address_id, $cart);
                }
//        }
            }
    ...
    public function createOrder($total_amount, $ship_address_id, $bill_address_id, $cart) {
...
//
//                    if ($order->save()) {
        // set parameter for checkout final page
        $newparams = array();
        $newparams['total_amt'] = $total_amount;
        $newparams['carts'] = $cart;

        // delete from carts table
        $this->removeFromCart($cart);


        $this->redirect('checkoutFinal', array($newparams));
//                    } else {
...
//                    }
    ...
    public function removeFromCart($carts) {
