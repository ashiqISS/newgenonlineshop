        ...
        <div class="col-md-6">
            ...
            <div class=" bill_form" style="padding-top: 1em;">
                ...
                <div class="form-group form_mrg">
                    ...
                    <?php echo CHtml::activeDropDownList($billing, '[bill]state', CHtml::listData(States::model()->findAllByAttributes(array()), 'Id', 'state_name'), array('empty' => '--Select State--', 'class' => 'form-control aik', 'options' => array('id' => array('selected' => 'selected')))); ?>
