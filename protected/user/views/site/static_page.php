<style>
    ...
    <section class="banner">
        ...
        <?php
        if ($model->banner) {
            $url = Yii::app()->request->baseUrl . '/uploads/static/' . $model->id . '/banner.' . $model->banner;
        } else {

            $url = Yii::app()->request->baseUrl . "/images/img_inn.jpg";
        }
        ?>
        <div id="large-header" class="large-header" style="height: 124px; background: url(<?= $url ?>)">
            ...
            <div class="container">
                <div class="row">
                    <?php if ($model->big_image) { ?>
                        <div class="left col col-md-4 col-sm-4 col-xs-6 col-xs-12 fill adjust_img">
                        ...
                        <div class="left col col-md-8 col-sm-8 col-xs-12 ab_rgt ">
