                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: left;" class="">
                                                    <form action="<?php echo Yii::app()->request->baseUrl; ?>/index.php/cart/updatecart" method="post" id="qty_<?php echo $cart->id; ?>">
                                                        ...
                                                        <select  class="quantity qty" id="<?php echo $cart->id; ?>" name="cart_quantity" cart="<?php echo $cart->id; ?>">
                                                            <?php foreach (range(1, $prod_details->quantity) as $number) { ?>
                                                                <option <?= $cart->quantity == $number ? 'selected' : '' ?> value="<?= $number; ?>" class="jsNumeric jsQty p0  qty"><?= $number; ?> </option>
                                                            <?php } ?>
                                                        </select>
                                                        <?php /*
