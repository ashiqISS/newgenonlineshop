                        ...
                        <table>
                            <tr>
                                <td style="border: 1px solid #ddd;
                                    ...
                                    <?php echo $user_address->first_name . ' ' . $user_address->first_name; ?>   <span>   </span><br>
                                ...
                                <td style="  border: 1px solid #ddd;
                                    ...
                                    <?php echo $bill_address->first_name . ' ' . $bill_address->last_name; ?>  <span>   </span><br>
                                    <?php echo $bill_address->address_1 . ', ' . $bill_address->address_2; ?><br>
                                    <?php
                                    if ($bill_address->contact_number != '') {
                                        echo $bill_address->contact_number . '<br>';
                                    }
                                    ?>
